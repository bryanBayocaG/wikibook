...
export const Tabs = ({
    ...
    return (
        <>
            <div
                className={cn(
                    "flex flex-row -mt-5 md:-mt-0 items-center justify-start [perspective:1000px] relative overflow-auto sm:overflow-visible no-visible-scrollbar max-w-full w-full",
                    containerClassName
                )}
            >
